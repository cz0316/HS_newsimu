#' Title irregular_pattern with noise, ZINB or ZIP
#' @description  irregular_pattern with noise, swap noise function 1, ZINB or ZIP, for irregular pattern.
...
#' @export
ire.noise=function(noise=0.1,lambda = 0.7, spots, se, ns, type, se.p, se.size = 0.2,
...
## 针对irregular pattern的对数正态swap noise函数,其他分布和没有noise相同
#' Title irregular_pattern with noise, swap noise function 2, logNormal
...
#' @return A data.frame of gene expression counts and coordinates.
#' @export
ire.norm=function (noise=0.2,cut=5,lambda = 0.7, spots, se, ns, se.p, ns.p, se.sd = 0.2,
